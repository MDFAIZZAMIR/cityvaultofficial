  ...
  return <section className='py-16 px-4 bg-gray-100'>
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className='text-gray-600 text-sm tracking-tighter'>On all order above $100.00</p>
      </div>
      {/**Feature 2 */}
      <div className="flex flex-col items-center">
        <div className="p-4 rounded-full mb-4">
        ...
        <p className='text-gray-600 text-sm tracking-tighter'>100% Money Back Guarantee</p>
      </div>
      {/**Feature 3 */}
      <div className="flex flex-col items-center">
        <div className="p-4 rounded-full mb-4">
